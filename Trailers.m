...
- (void)reviewPressed {
    ...
    // Report to  analytics
    NSError *error;
    if (![[GANTracker sharedTracker] trackEvent:@"User Sent to Review Biology iGCSE Videos iPad at app store"
                                         action:@"User Sent to Review Biology iGCSE Videos iPad at app store"
                                          label:@"User Sent to Review Biology iGCSE Videos iPad at app store"
                                          value:1
                                      withError:&error]) {
