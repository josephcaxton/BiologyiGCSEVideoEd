...
- (void)viewDidLoad {
	...
	//[listofItems addObject:@"Cambridge iGCSE Biology Examination Board"];
    //[listofItemsFileNames addObject:@"Biology-Cambridge-IGCSE"];
    
    [listofItems addObject:@"Edexcel iGCSE Biology Examination Board"];
    [listofItemsFileNames addObject:@"Biology-Edexcel-IGCSE"];
