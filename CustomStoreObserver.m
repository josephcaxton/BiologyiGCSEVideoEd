...
-(NSString *)WorkOutSubsriptionInDays:(NSString*)theProductID{
    ...
    if ([[theProductID lowercaseString] isEqualToString:@"biologyigcseedipad1week"] ){
        
        return @"7";
        
    }

  else if ([[theProductID lowercaseString] isEqualToString:@"biologyigcseedipad1month"] ){
        
        return @"31";
        
    }
    
    else if ([[theProductID lowercaseString] isEqualToString:@"biologyigcseedipad3months"] ){
        
        return @"93";
        
    }
    else if ([[theProductID lowercaseString] isEqualToString:@"biologyigcseedipad6months"] ){
        
        return @"186";
        
    }
    
    else if ([[theProductID lowercaseString] isEqualToString:@"biologyigcseedipad9months"] ){
        
        return @"279";
        
    }
    else if ([[theProductID lowercaseString] isEqualToString:@"biologyigcseedipad12months"] ){
