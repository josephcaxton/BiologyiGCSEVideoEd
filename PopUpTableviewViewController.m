...
@synthesize m_popover,facebook,logoutFacebook,activityIndicator,SendMailcontroller;
...
-(IBAction)ShareThisAppViaMail:(id)sender{
	...
	if ([MFMailComposeViewController canSendMail]) {
        ...
        //NSArray *SendTo = [NSArray arrayWithObjects:@"support@LearnersCloud.com",nil];
         ...
         SendMailcontroller = [[MFMailComposeViewController alloc]init];
        SendMailcontroller.mailComposeDelegate = self;
        //[SendMailcontroller setToRecipients:SendTo];
        [SendMailcontroller setSubject:@"Learn and revise Biology iGCSE on the go - Biology App"];
...
-(void)ConnectToFaceBook {
    ...
    NSMutableDictionary* params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   @"I’ve just started using a new Biology videos App! Hundreds of quality Biology videos. You should check it out, or search LearnersCloud in your device’s App store.",  @"message",nil];
